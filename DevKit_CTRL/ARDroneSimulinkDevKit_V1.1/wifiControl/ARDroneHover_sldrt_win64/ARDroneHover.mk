...
MAKECMD         = "C:/PROGRA~1/POLYSP~1/R2020b/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := ARDroneHover
MODULES              := DAHostLib_Network.c DAHostLib_rtw.c ARDroneHover_data.c ARDroneHover_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := ARDroneHover.mk
...
TID01EQ              := 1
NCSTATES             := 5
BUILDARGS            :=  EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1"
MULTITASKING         := 0
EXT_MODE             := 1
EXTMODE_TRANSPORT    := 0
...
SLDRTDIR             := C:/PROGRA~1/POLYSP~1/R2020b/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ARDroneHover_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/21_22_UAVs_Lab3_Final/DevKit_CTRL_Exp/ARDroneSimulinkDevKit_V1.1/wifiControl;$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include;D:/21_22_UAVs_Lab3_Final/DevKit_CTRL_Exp/ARDroneSimulinkDevKit_V1.1/wifiControl/ARDroneHover_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
...
CPPSRCDIRS := $(RELATIVE_PATH_TO_ANCHOR) $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/src $(MATLAB_ROOT)/rtw/c/src $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/rtw/c/src/ext_mode/common 
