...
extern void ARDroneHover_BitConcat(uint8_T rtu_u1, uint8_T rtu_u2, uint8_T
  rtu_u3, uint8_T rtu_u4, B_BitConcat_ARDroneHover_T *localB);
extern void ARDroneHover_MATLABFunction_Init(DW_MATLABFunction_ARDroneHover_T
  *localDW);
extern void ARDroneHover_MATLABFunction(real_T rtu_u,
  B_MATLABFunction_ARDroneHover_T *localB, DW_MATLABFunction_ARDroneHover_T
  *localDW);
