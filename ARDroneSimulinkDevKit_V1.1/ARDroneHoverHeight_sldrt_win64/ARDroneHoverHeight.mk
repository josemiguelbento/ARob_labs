...
MAKECMD         = "C:/PROGRA~1/POLYSP~1/R2020a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := ARDroneHoverHeight
MODULES              := DAHostLib_Network.c DAHostLib_rtw.c ARDroneHoverHeight_data.c ARDroneHoverHeight_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := ARDroneHoverHeight.mk
...
SLDRTDIR             := C:/PROGRA~1/POLYSP~1/R2020a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ARDroneHoverHeight_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/josem/DOCUME~1/IST/4ANO1S~1/AERONA~1/DEVKIT~1/ARDRON~1.1;$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include;C:/Users/josem/DOCUME~1/IST/4ANO1S~1/AERONA~1/DEVKIT~1/ARDRON~1.1/ARDroneHoverHeight_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src;$(MATLAB_ROOT)/toolbox/aeroblks/aeroblks;$(MATLAB_ROOT)/toolbox/aero/aero/src
...
CPPSRCDIRS := $(RELATIVE_PATH_TO_ANCHOR) $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/toolbox/aeroblks/aeroblks $(MATLAB_ROOT)/toolbox/aero/aero/src $(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/src $(MATLAB_ROOT)/rtw/c/src $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/rtw/c/src/ext_mode/common 
