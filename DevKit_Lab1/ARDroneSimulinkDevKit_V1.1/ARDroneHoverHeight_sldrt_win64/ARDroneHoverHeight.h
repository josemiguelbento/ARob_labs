...
#ifndef RTW_HEADER_ARDroneHoverHeight_h_
#define RTW_HEADER_ARDroneHoverHeight_h_
#include <math.h>
#include <string.h>
#ifndef ARDroneHoverHeight_COMMON_INCLUDES_
# define ARDroneHoverHeight_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "sldrtdef.h"
#endif                                 /* ARDroneHoverHeight_COMMON_INCLUDES_ */

#include "ARDroneHoverHeight_types.h"
...
#define ARDroneHoverHeight_rtModel     RT_MODEL_ARDroneHoverHeight_T
...
typedef struct {
  ...
  real_T enablecommandstep;            /* '<Root>/enable command step' */
  real_T disablecommandstep;           /* '<Root>/disable command step' */
  ...
  real_T yawref;                       /* '<Root>/Heading ref (rad)' */
  real_T climbstep;                    /* '<Root>/climb step' */
  real_T descendstep;                  /* '<Root>/descend step' */
  real_T Product2;                     /* '<Root>/Product2' */
  real_T altituderef;                  /* '<Root>/Sum' */
  real_T xeref;                        /* '<Root>/Inertial X ref (m)' */
  real_T yeref;                        /* '<Root>/Inertial Y ref (m)' */
  real_T toffstep2;                    /* '<Root>/toff step2' */
  real_T landstep1;                    /* '<Root>/land step1' */
  real_T Product;                      /* '<Root>/Product' */
  real_T TmpSignalConversionAtToWorkspaceInport1[15];
  real_T TmpSignalConversionAtToWorkspaceInport1_o[9];
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ToWorkspace_PWORK_b;               /* '<S4>/To Workspace' */
...
#define rtB                            ARDroneHoverHeight_B
#define BlockIO                        B_ARDroneHoverHeight_T
#define rtX                            ARDroneHoverHeight_X
#define ContinuousStates               X_ARDroneHoverHeight_T
#define rtXdot                         ARDroneHoverHeight_XDot
#define StateDerivatives               XDot_ARDroneHoverHeight_T
#define tXdis                          ARDroneHoverHeight_XDis
#define StateDisabled                  XDis_ARDroneHoverHeight_T
#define rtP                            ARDroneHoverHeight_P
#define Parameters                     P_ARDroneHoverHeight_T
#define rtDWork                        ARDroneHoverHeight_DW
#define D_Work                         DW_ARDroneHoverHeight_T

/* Parameters (default storage) */
struct P_ARDroneHoverHeight_T_ {
  ...
  int32_T UDPSend_remotePort_a;        /* Mask Parameter: UDPSend_remotePort_a
                                        ...
                                        */
  real_T stepvalue_Value;              /* Expression: 1
                                        * Referenced by: '<Root>/step value'
                                        */
  real_T ini_step_value_Value;         /* Expression: 0
  ...
  real_T UnitDelaytoavoidalgebraicloop_InitialCondition;/* Expression: 0
                                                         ...
                                                         */
  real_T enablecommandstep_Time;       /* Expression: 15
                                        * Referenced by: '<Root>/enable command step'
                                        */
  real_T enablecommandstep_Y0;         /* Expression: 0
                                        * Referenced by: '<Root>/enable command step'
                                        */
  real_T enablecommandstep_YFinal;     /* Expression: 1
                                        * Referenced by: '<Root>/enable command step'
                                        */
  real_T disablecommandstep_Time;      /* Expression: 60
                                        * Referenced by: '<Root>/disable command step'
                                        */
  real_T disablecommandstep_Y0;        /* Expression: 1
                                        * Referenced by: '<Root>/disable command step'
                                        */
  real_T disablecommandstep_YFinal;    /* Expression: 0
                                        * Referenced by: '<Root>/disable command step'
                                        */
  ...
  real_T Heightrefm_Value;             /* Expression: 0.75
                                        ...
                                        */
  real_T climbstep_Time;               /* Expression: 20
                                        * Referenced by: '<Root>/climb step'
                                        */
  real_T climbstep_Y0;                 /* Expression: 0
                                        * Referenced by: '<Root>/climb step'
                                        */
  real_T climbstep_YFinal;             /* Expression: 1
                                        * Referenced by: '<Root>/climb step'
                                        */
  real_T descendstep_Time;             /* Expression: 40
                                        * Referenced by: '<Root>/descend step'
                                        */
  real_T descendstep_Y0;               /* Expression: 1
                                        * Referenced by: '<Root>/descend step'
                                        */
  real_T descendstep_YFinal;           /* Expression: 0
                                        * Referenced by: '<Root>/descend step'
                                        */
  ...
  real_T InertialYrefm_Value;          /* Expression: 0
                                        ...
                                        */
  real_T toffstep2_Time;               /* Expression: 2
                                        * Referenced by: '<Root>/toff step2'
                                        */
  real_T toffstep2_Y0;                 /* Expression: 0
                                        * Referenced by: '<Root>/toff step2'
                                        */
  real_T toffstep2_YFinal;             /* Expression: 1
                                        * Referenced by: '<Root>/toff step2'
                                        */
  real_T landstep1_Time;               /* Expression: 65
                                        * Referenced by: '<Root>/land step1'
                                        */
  real_T landstep1_Y0;                 /* Expression: 1
                                        * Referenced by: '<Root>/land step1'
                                        */
  real_T landstep1_YFinal;             /* Expression: 0
                                        * Referenced by: '<Root>/land step1'
                                        */
  real_T deg2rad1_Gain;                /* Expression: 180/pi
                                        * Referenced by: '<S4>/deg 2 rad1'
                                        */
  real_T proportionalcontrolgain_Gain; /* Expression: 0.5
  ...
  uint8_T ManualSwitch2_CurrentSetting;
                              ...
                              */
  uint8_T step_CurrentSetting;        /* Computed Parameter: step_CurrentSetting
                                       * Referenced by: '<Root>/step'
                                       */
};

/* Real-time Model Data Structure */
struct tag_RTM_ARDroneHoverHeight_T {
  const char_T *path;
...
extern P_ARDroneHoverHeight_T ARDroneHoverHeight_P;

/* Block signals (default storage) */
extern B_ARDroneHoverHeight_T ARDroneHoverHeight_B;

/* Continuous states (default storage) */
extern X_ARDroneHoverHeight_T ARDroneHoverHeight_X;

/* Block states (default storage) */
extern DW_ARDroneHoverHeight_T ARDroneHoverHeight_DW;

/* Model entry point functions */
extern void ARDroneHoverHeight_initialize(void);
extern void ARDroneHoverHeight_output(void);
extern void ARDroneHoverHeight_update(void);
extern void ARDroneHoverHeight_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern ARDroneHoverHeight_rtModel *ARDroneHoverHeight(void);
...
extern RT_MODEL_ARDroneHoverHeight_T *const ARDroneHoverHeight_M;
 ...
 *
 * '<Root>' : 'ARDroneHoverHeight'
 * '<S1>'   : 'ARDroneHoverHeight/ARDrone Wi-Fi  Block'
 * '<S2>'   : 'ARDroneHoverHeight/Baseline Controller'
 * '<S3>'   : 'ARDroneHoverHeight/State estimation Important:This block provides an  inaccurate extimation of position  based on  velocity information. '
 * '<S4>'   : 'ARDroneHoverHeight/Visualization of Drone states'
 * '<S5>'   : 'ARDroneHoverHeight/ARDrone Wi-Fi  Block/ARDrone data decoding'
 * '<S6>'   : 'ARDroneHoverHeight/ARDrone Wi-Fi  Block/Data synchronization '
 * '<S7>'   : 'ARDroneHoverHeight/ARDrone Wi-Fi  Block/Subsystem1'
 * '<S8>'   : 'ARDroneHoverHeight/ARDrone Wi-Fi  Block/This block sets the heading angle to zero when the  commands from the Simulink controller are enabled. '
 * '<S9>'   : 'ARDroneHoverHeight/ARDrone Wi-Fi  Block/Subsystem1/Drone state request'
 * '<S10>'  : 'ARDroneHoverHeight/ARDrone Wi-Fi  Block/Subsystem1/send byte to  state udp port  '
 * '<S11>'  : 'ARDroneHoverHeight/Baseline Controller/Forward velocity controller '
 * '<S12>'  : 'ARDroneHoverHeight/Baseline Controller/Heading controller'
 * '<S13>'  : 'ARDroneHoverHeight/Baseline Controller/Height controller '
 * '<S14>'  : 'ARDroneHoverHeight/Baseline Controller/Lateral velocity controller'
 * '<S15>'  : 'ARDroneHoverHeight/Baseline Controller/Position controller'
 * '<S16>'  : 'ARDroneHoverHeight/Baseline Controller/Heading controller/normalize angle  between -pi and pi radians'
 * '<S17>'  : 'ARDroneHoverHeight/Baseline Controller/Position controller/Coordinate trnasformation  from inertial frame to body frame '
 * '<S18>'  : 'ARDroneHoverHeight/State estimation Important:This block provides an  inaccurate extimation of position  based on  velocity information. /Position estimation'
 * '<S19>'  : 'ARDroneHoverHeight/State estimation Important:This block provides an  inaccurate extimation of position  based on  velocity information. /Position estimation/Velocity from vehicle body frame  to inertial NED  frame'
 */
#endif                                 /* RTW_HEADER_ARDroneHoverHeight_h_ */
