...
if show_pre_proc
    figure();
    plot(input_t,theta*180/pi,input_t,phi*180/pi)
    legend('pitch','roll')
    xlabel('t [s]')
    ylabel('attitude [º]')
    title('Theoretical attitude used for validation')
...
title('Real and estimated pitch')
